...
summary(res)
# out of 413 with nonzero total read count
...
write.csv(res, file="DESeq2_Results_ITS/time_effect_pf_v_fb.csv")
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fl1_v_fb.csv")
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fl2_v_fb.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fd2_v_fb.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm1_v_fb.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm2_v_fb.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fl1_v_pf.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fl2_v_pf.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fd2_v_pf.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm1_v_pf.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm2_v_pf.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fl2_v_fl1.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fd2_v_fl1.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm1_v_fl1.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm2_v_fl1.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fd2_v_fl2.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm1_v_fl2.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm2_v_fl2.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm1_v_fd2.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm2_v_fd2.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
res <- res[order(res$padj),]
res <- as.data.frame(res)
write.csv(res, file="DESeq2_Results_ITS/time_effect_fm2_v_fm1.csv")
res <- res[,c(2,6)][match(rownames(all_Wald_results), rownames(res)),]
...
write.csv(vsd_data, file="DESeq2_Results_ITS/variance_stabilized_transform_pulp.csv")

# 2
write.csv(all_Wald_results, file="DESeq2_Results_ITS/all_Wald_results_pulp.csv")

# 3
tax <- as.data.frame(physeq@tax_table)
write.csv(tax, file="DESeq2_Results_ITS/tax_table_pulp.csv")

# 4
normalized_counts <- as.data.frame(counts(dds, normalized = T))
write.csv(normalized_counts, file="DESeq2_Results_ITS/normalized_data_pulp.csv")
...
write.csv(data_with_clust_info, "Figures_ITS/clusters_pulp_relabund.csv")

pdf("Figures_ITS/clusters_pulp_relabund.pdf")
cluster_plot
dev.off()
...
# [5,] "Replicates_fact_5_vs_1"   
# [6,] "Replicates_fact_6_vs_1"   
# [7,] "Replicates_fact_7_vs_1"   
# [8,] "Timepoints_fact_pf_vs_fb" 
# [9,] "Timepoints_fact_fl1_vs_fb"
# [10,] "Timepoints_fact_fl2_vs_fb"
# [11,] "Timepoints_fact_fd2_vs_fb"
# [12,] "Timepoints_fact_fm1_vs_fb"
# [13,] "Timepoints_fact_fm2_vs_fb"
...
res <- results(dds, contrast = c("Replicates_fact", "2", "1")) # only 1 OTU significant
summary(res)
# out of 932 with nonzero total read count
# adjusted p-value < 0.1
# LFC > 0 (up)       : 5, 0.54%
# LFC < 0 (down)     : 8, 0.86%
# outliers [1]       : 0, 0%
...
vsd <- varianceStabilizingTransformation(dds, blind=FALSE)
vsd_data <- as.data.frame(assay(vsd))
write.csv(vsd_data, file="DESeq2_Results_ITS/variance_stabilized_transform_skin.csv")

# 2
write.csv(all_Wald_results, file="DESeq2_Results_ITS/all_Wald_results_skin.csv")

# 3
tax <- as.data.frame(physeq@tax_table)
write.csv(tax, file="DESeq2_Results_ITS/tax_table_skin.csv")

# 4
normalized_counts <- as.data.frame(counts(dds, normalized = T))
write.csv(normalized_counts, file="DESeq2_Results_ITS/normalized_data_skin.csv")
...
# save plot and clusters to file
write.csv(data_with_clust_info, "Figures_ITS/clusters_skin_relabund.csv")

pdf("Figures_ITS/clusters_skin_relabund.pdf")
cluster_plot
dev.off()
